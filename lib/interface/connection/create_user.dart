...
class _CreateAccountState extends State<CreateAccount> {
  ...
  List<Map<String, String>> activityItem = [
    ...
    {'value': 'AgroAlimentaire', 'label': 'AgroAlientaire'},
    {'value': 'Aniaux', 'label': 'Animaux'},
    ...
    {'value': 'Jeux et divertissements', 'label': 'Jeux et divertissements'},
    ...
    {'value': 'Décoration interieur', 'label': 'Décoration interieur'},
  ];
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Text(
                "Apprêtez vous à entrez dans un univers où vous êtes le véritable patron.",
            ...
            Container(
              child: Form(
                ...
                child: Column(
                  children: [
                    itemTextFieldText(
                        label: 'Votre Nom ou celui de votre boutique',
                        hint: 'Ex. Paul / MK Store',
                        controller: nom,
                        validator: simpleValidator),
                    itemTextFieldText(
                        label: 'Votre adresse mail',
                        hint: 'Ex. monemail@gmail.com',
                        controller: email,
                        validator: simpleValidator),
                    itemTextFieldText(
                    ...
                    itemSelectForm(
                        ...
                        hint: 'Mode'),
                    itemAdresseField(
                        label: 'Votre adresse ou celle de votre boutique ',
                        hint: 'Choisir'),
                    ...
                    Container(
                      ...
                      child: Text(
                        "En validant ce formulaire vous acceptez nos conditions d'utilisation et notre politique de confidentialité.",
            ...
            if (showErrorR == true)
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    color: type == 2
                        ? Colors.red
                        : const Color.fromARGB(255, 45, 135, 48)),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Container(
  ...
  itemAdresseField({required label, required hint}) {
    return Container(
        ...
        children: [
          ...
          Container(
            child: SelectFormField(
              ...
              decoration: InputDecoration(
                  hintText: hint, hintStyle: GoogleFonts.roboto(fontSize: 12)),
              dialogSearchHint: 'Chercher',
              enableSearch: true,
              style: GoogleFonts.roboto(),
              type: SelectFormFieldType.dialog,
              items: [for (var item in activityItem) item],
              onChanged: (value) {
                setState(() {
  ...
  onCreateUser() {
    ...
    Address adress =
        Address(countryCode: '225', state: 'CI', city: adresse.text);
