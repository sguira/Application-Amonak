...
import 'package:application_amonak/interface/details/details_item_pub.dart';
...
class _DetailsPublicationState extends State<DetailsPublication> {
  ...
  Future<String> loadPub(int limite)async{
    ...
    return await  PublicationService.getPublicationById(id: widget.pubId).then((value)async{
      if(value.statusCode==200){
        setState(() {
          pub=Publication.fromJson(jsonDecode(value.body));
        });
        await CommentaireService.getCommentByPublication(pubId: widget.pubId,limite: limite).then((value){
          if(value.statusCode==200){
            commentaires=[];
          ...
          child: Container(
            ...
            child: ListView(
              children: [
                ...
                Container(
                  child: DetailsItemPubliction(pub: pub, publicationSocket: publicationSocket),
                ),
                      ...
                      children: [
                        ...
                        AnimatedSwitcher(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(
                              color: couleurPrincipale.withAlpha(60)
                            )
                          ),
                        child:commentText.text.isNotEmpty &&commentText.text.isBlank==false ? IconButton(
                          onPressed: (){
                            ...
                            CommentaireService.saveComent(com).then((value){
                              if(value.statusCode==200){
                                setState(() {
                                  setState(() {
                                    commentaires.insert(0, Commentaire.fromJson(jsonDecode(value.body)));
                                    commentaires[0].isLike=false;
                                  });
                                });
                              }
                            });
                  
                        }, icon:const Icon(Icons.send_rounded,color: couleurPrincipale,size: 22,)):null),
                        )
                      ],
                    ),
                  ),
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Container(
                        child: Text("Les commentaires",style: GoogleFonts.roboto(fontSize: 14,fontWeight: FontWeight.w700,color: couleurPrincipale),),
                        ...
                        child: DropdownButton(
                          ...
                          onChanged: (value){
                            setState(() {
                              ...
                              if(currentDropDownValue==dropDownList.first){
                                setState(() {
                                  loadPub(5);
                                });
                              }
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        ItemCommentaire(com: item, setState_: (){}, pubId: widget.pubId)
                      ],
                    ),
                  )
                )
