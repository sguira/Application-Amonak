...
class _DetailArticleState extends State<DetailArticle> {
          ...
          children: [
            Positioned.fill(
                ...
                child: Container(
                    ...
                    // width: ,
                    child: widget.article.files.isEmpty ||
                            widget.article.files.first.type != 'video'
                        ? Image.asset(
                            "assets/medias/articles/article2.jpg",
                            fit: BoxFit.cover,
                          )
                        : VideoBacground(
                            url: widget.article.files.first.url!))),
            Positioned(
              bottom: 10,
            ...
            Row(
              ...
              children: [
                SizedBox(
                  ...
                  child: Column(
                    children: [articleContent(), formContainer(context)],
                  ),
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
          ...
          children: [
            TextFieldDisable(
                ...
                value: NumberFormat.currency(
                        locale: 'fr',
                        decimalDigits: 0,
                        symbol: widget.article.currency)
                    .format(widget.article.livraison)),
            TextFieldDisable(
                label: "Livraison",
                value: NumberFormat.currency(
                        locale: 'fr',
  ...
  Container buttonJeveux(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
          gradient: linearGradient, borderRadius: BorderRadius.circular(36)),
      child: Center(
          child: TextButton(
              onPressed: () {
                Navigator.push(
    ...
    return Column(
      children: [
        ...
        Container(
            ...
            child: Column(
              children: [ButtonLike(pub: widget.article)],
            )),
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
            ...
            hintText: NumberFormat.currency(
                    locale: 'fr', decimalDigits: 0, symbol: 'CFA')
                .format(double.parse(hint)),
  ...
  viewModal() {
    return showModalBottomSheet(
        ...
        builder: (context) => Container(
              child: SingleChildScrollView(
                child: Column(
                  children: [headerBottomSheet(context, '')],
                ),
              ),
            ));
  }
