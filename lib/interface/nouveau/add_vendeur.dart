    ...
    return Scaffold(
      appBar: AppBar(
        title: Row(
          ...
          children: [
            const Spacer(),
            Text('Devenir Vendeur'.toUpperCase(),style: GoogleFonts.roboto(fontSize: 12,fontWeight: FontWeight.w700),),
            const Spacer(flex: 2,)
          ],
        ),
      ),
      ...
      child: Column(
        children: [
          ...
          AnimatedSwitcher(
            ...
            child: currentIndex==1?containerForm():currentIndex==2?formContainerChoiceTypePayement():validationForm(),
          )
        ],
      ),
    );
          ...
          children: [
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  border: OutlineInputBorder(
                    borderSide:const BorderSide(color: Color.fromARGB(75, 0, 0, 0), width: 1), 
                    borderRadius: BorderRadius.circular(10)
                  ), 
                  enabledBorder: OutlineInputBorder(
                    borderSide:const BorderSide(color: Color.fromARGB(50, 0, 0, 0), width: 1), 
                    borderRadius: BorderRadius.circular(10)
                  ),
                ),
              ),
                ...
                Container(
                  ...
                  child: TextButton(onPressed: (){
                    ...
                    children: [
                      ...
                      Text('Importer une pièce d\'identité',style: GoogleFonts.roboto(fontSize:12)), 
                    ],
                  )),
                ),
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 16),
                  child: Text('Passeport, CNI, permis de conduire... valide',style: GoogleFonts.roboto(fontSize: 10),),
                ),
              ],
            ),
            ...
            Container(
                  ...
                  child: TextButton(onPressed: (){
                    ...
                    children: [
                      const Icon(Icons.file_upload_outlined),
                      const SizedBox(width: 12,),
                      Text("Veuillez importer une vidéo de vos articles",style: GoogleFonts.roboto(fontSize:12)), 
                    ],
                  )),
                ),
            ...
            Container(
              ...
              child: TextButton(
                onPressed: (){
                  if(keyForm.currentState!.validate()){
                    if(pieceFile!=null && articleFile!=null){
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Veuillez entrée une pièce d\'identité')));
                    }
                  }
                },
                ...
                child: Center(child: Text("Continuez".toUpperCase(),style: GoogleFonts.roboto(color: Colors.white),))
              ),
            )
          ],
        ),
    ...
    return Container(
      ...
      child: TextButton(
        ...
        children: [
          ...
          Text(label,style: GoogleFonts.roboto(color: Colors.black,fontSize: 12),)
        ],
      )),
    );
  }
            ...
            children: [
              Container(
                ...
                child: TextButton(
                  ...
                  child: Center(child: Text("revenir".toUpperCase(),style: GoogleFonts.roboto(color: Colors.black),))),
              ),
            ],
          )
        ],
        ...
        child: Column(
          children: [
            Container(
              ...
              child: ClipRRect(
                borderRadius: BorderRadius.circular(10),
                child: Image.asset("assets/medias/$image",fit: BoxFit.cover,)),
            ), 
            Text(label,style: GoogleFonts.roboto(fontSize: 11,fontWeight: FontWeight.w600),)
          ],
        ),
      ),
    );
    ...
    return Container(
      ...
      child: Form(
        ...
        child: Column(
          children: [
            itemTypePayement('Orange Money', 'orange.png'), 
            itemForm(controller: numero,label: 'Numéro de téléphone',hint: 'Entrer le numéro de téléphone associé au compte'), 
            itemForm(controller: name,label: 'Nom du proprietaire',hint: 'Entrer le nom associé au compte...'), 
            Container(
              margin:const EdgeInsets.symmetric(horizontal: 12),
              child: TextButton(
                style: TextButton.styleFrom(
                ...
                child: Center(child:waitSend==false? Text("Envoyer".toUpperCase(),style: GoogleFonts.roboto(color: Colors.white,fontWeight: FontWeight.w500,fontSize:13),):const SizedBox(width: 18,height: 18,child: Center(child: CircularProgressIndicator(color: Colors.white,strokeWidth: 1,),),))
              ),
            )
