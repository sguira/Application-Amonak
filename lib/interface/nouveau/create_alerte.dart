...
class _CreateAlertePageState extends State<CreateAlertePage> {
            ...
            child: Column(
              children: [
                Container(
                  margin: const EdgeInsets.symmetric(horizontal: 0),
                  child: Text(
                    "Si vous recherchez un article rare et/ou urgent, c’est le moment d’alerter les vendeurs qui peuvent potentiellement vous faire des propositions.",
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          ...
                          child: multilineTexteForm(
                            controller: description,
                            hint: "Que recherchez-vous ?",
                          ),
                        ),
                        itemForm(
                            hint: 'Ex. Chaussure Givenchy paris',
                            label: "Nom de l’article",
                            controller: articleName,
                            requiet: true),
                        buttonImportFile(
                            label: 'Importer une photo / vidéo de l’article',
                            function: loadFile),
                        if (selectedFile != null)
                          FileSelectedViewer(
                              file: selectedFile!, onClose: onClose),
                        // if (alerte)
                        //   Container(
        ...
        child: Row(
          ...
          children: [
            SizedBox(
                width: 200,
                child: Text(
                  'Video chargée :${selectedFile!.path.split('\\').last}',
                  style: GoogleFonts.roboto(
                      fontSize: 11,
                      color: Colors.red,
  ...
  saveAlerte() async {
    if (selectedFile != null) {
      ...
      await PublicationService.uploadFileOnserver(
              file: selectedFile!,
